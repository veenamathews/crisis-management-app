export const TELEGRAM_CHANNEL_EN = {
  "name": "Help for Ukrainians in Germany",
  "type": "public_channel",
  "id": 1650038103,
  "messages": [
   {
    ...
    "title": "Help to Ukrainians in Germany",
    "text": ""
   },
   {
    "id": 2,
   ...
   },
   {
    ...
    "text": [
     ...
     {
      "type": "link",
      "text": "https://docs.google.com/forms/d/e/1FAIpQLSeLQvMqfQM6AFIMYmgJyUltwxpM8kDK-kRc-k5V_APtGpDZmQ/viewform?fbclid=IwAR0Ff5AOfz3yc8aYLtzQia38hFzeerg2954ye7Mfdz3KZffN4ots"
     },
     "\n\nRegister"
    ]
   },
   {
    ...
    "text": [
     ...
     {
      "type": "link",
      "text": "https://docs.google.com/forms/d/e/1FAIpQLScWDnuCXAxYoJ9WP-U7ZGzGoHqcR7Ll1shKg7Vorwdgw_ibtg/viewform?fbclid=IwAR3hQ-EsQhvlRtSePL1VcWuwxTQMLFQfkUfhbWvZzzWb_dJbgOBUx09"
     },
     "\n\nRegister"
    ]
   },
   ...
   },
   {
    ...
    "text": [
     ...
     {
      "type": "link",
      "text": "https://www.verbraucherzentrale.de/wissen/gesundheit-pflege/aerzte-und-kliniken/medizinische-versorgung-von-asylbewerbern-12312"
     },
     ""
    ]
   },
   ...
   },
   {
    ...
    "from_id": "channel1650038103",
    "text": [
     "Register Refugees Berlin Brandenburg \n\n",
     {
      "type": "link",
   ...
   },
   {
    ...
    "text": [
     ...
     "\n\nWir grüßen Euch!\n\n Wir, ukrainische Mädchen und Männer in Stuttgart und Umgebung, haben uns zusammen geschlossen und die Gruppe Help🇺🇦 UKRAINE gegründet!\n\n Wir haben jetzt ein PayPal-Spendenkonto eingerichtet. \n\n Zweck der Sammlung: Kauf notwendiger Medikamente, die heute in der Ukraine nicht erhältlich sind.\n\n PayPal: ",
     {
      "type": "email",
      "text": "helpforukraine22@gmail.com"
     },
     ". (Matthias Schmidt)\n\n Medikamente werden in ein Lager in Polen gebracht, dann überquert ein LKW mit einer Sondergenehmigung unverzüglich die Grenze unseres Landes entlang des grünen Korridors!\n\nWir arbeiten direkt mit ",
     {
      "type": "link",
      "text": "https://www.plast.org.ua/"
     },
     "zusammen.\n\nIn der Einheit liegt unsere Starke!"
    ]
   },
   {
    "id": 36,
   ...
   },
   {
    ...
    "author": "Kirill",
    "text": [
     "Vіdkritiy channel for the support of Ukraine in Nіmechchinі: ",
     {
      "type": "link",
   ...
   },
   {
    ...
    "author": "Kirill",
    "text": [
     "Point for the reception of humanitarian aid on Alexanderplats in Berlin",
     {
      "type": "link",
      "text": "https://goo.gl/maps/oNvYySLUvz5rHT68A"
     },
     "NECESSARY SPEECHES: get a guard (bulletproof vests, helmets, knee pads, skinny), faces (list below), sleeping bags, karemati, canned hedgehog (not slo). It is NOT REQUIRED to carry clothes."
    ]
   },
   {
    "id": 55,
    ...
    "from_id": "channel1650038103",
    "author": "Kirill",
    "text": "Expansion list of required medical conditions in a number of languages"
   },
   {
    "id": 56,
    "type": "message",
   ...
   },
   {
    ...
    "text": [
     ...
     {
      "type": "link",
      "text": "https://www.berlin.de/ba-friedrichshain-kreuzberg/politik-und-verwaltung/aemter/gesundheitsamt/zentrum-fuer-sexuelle-gesundheit-und-familienplanung/russ_flyer-zentrum-fk-15x15 .pdf"
     },
